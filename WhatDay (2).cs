...
namespace WhatDay2
{
        ...
        class WhatDay
        {
            static void Main(string[] args)
            {
                ...
                if (isLeapYear)
                {
                    dayNumUpperBound = 366;
                }
                else
                {
                    dayNumUpperBound = 365;
                }

                Console.Write("Please enter a day number between 1 and {0}: ", dayNumUpperBound);
                int dayNum = int.Parse(Console.ReadLine());

                if (dayNum < 1 || dayNum > dayNumUpperBound)
                {
                ...
                for (int i = 0; i < 12; i++)
                {
                    DaysInMonths[i] = DateTime.DaysInMonth(year, i + 1);
                }
            ...
            End:
                ...
                //}
                monthName = ((MonthName)monthNum).ToString();
